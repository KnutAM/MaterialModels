...
if (yielding>0) then ! Solve for plasticity
    ...
    !call newton_raphson_num(residualfun, x0, jac_inv, lconv, info, props, statev, param=Fnew, printres=3)
    
    !Calculate ddsdde, statev and stress from solution of local problem
    call plastic_output(x0,props,statev,Fnew,jac_inv,stressi,ddsddei,statevNew)
